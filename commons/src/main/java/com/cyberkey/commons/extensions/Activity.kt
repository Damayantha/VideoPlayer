...
import com.cyberkey.commons.databinding.DialogTitleBinding
...
import com.cyberkey.commons.models.*
import com.cyberkey.commons.views.MyTextView
import java.io.*
...
fun Activity.launchPurchaseThankYouIntent() {
    hideKeyboard()
    try {
        launchViewIntent("market://details?id=com.cyberkey.thankyou")
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.cyberkey.videoplayer" || applicationId == "com.cyberkey.videoplayer.debug") {
...
fun BaseSimpleActivity.launchCallIntent(recipient: String, handle: PhoneAccountHandle? = null) {
    handlePermission(PERMISSION_CALL_PHONE) {
        ...
        Intent(action).apply {
            ...
            if (isDefaultDialer()) {
                val packageName = if (baseConfig.appId.contains(".debug", true)) "com.cyberkey.phone.debug" else "com.cyberkey.phone"
                val className = "com.cyberkey.phone.activities.DialerActivity"
