...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.cyberkey.videoplayer.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.cyberkey.thankyou")
...
fun Context.isAProApp() = packageName.startsWith("com.cyberkey.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.cyberkey."))
...
val Context.shortcutManager: ShortcutManager @RequiresApi(Build.VERSION_CODES.N_MR1)
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.cyberkey.contacts") && !packageName.startsWith("com.cyberkey.phone")) {
        true
    } else if ((packageName.startsWith("com.cyberkey.contacts") || packageName.startsWith("com.cyberkey.phone")) && isQPlus()) {
...
fun Context.copyToClipboard(text: String) {
    val clip = ClipData.newPlainText(getString(R.string.cyberkey_commons), text)
