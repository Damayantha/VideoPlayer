...
import com.cyberkey.commons.databinding.ActivityCustomizationBinding
import com.cyberkey.commons.dialogs.ColorPickerDialog
import com.cyberkey.commons.dialogs.ConfirmationAdvancedDialog
import com.cyberkey.commons.dialogs.LineColorPickerDialog
...
import com.cyberkey.commons.models.MyTheme
import com.cyberkey.commons.models.RadioItem
import com.cyberkey.commons.models.SharedTheme
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    private var isThankYou = false      // show "Apply colors to all Cyberkey apps" in Cyberkey Thank You itself even with "Hide Google relations" enabled
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.cyberkey.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
