package com.cyberkey.commons.activities
...
import com.cyberkey.commons.asynctasks.CopyMoveTask
import com.cyberkey.commons.compose.extensions.DEVELOPER_PLAY_STORE_URL
import com.cyberkey.commons.dialogs.*
import com.cyberkey.commons.dialogs.WritePermissionDialog.WritePermissionDialogMode
import com.cyberkey.commons.extensions.*
import com.cyberkey.commons.helpers.*
import com.cyberkey.commons.interfaces.CopyMoveListener
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!packageName.startsWith("com.cyberkey.", true)) {
            if ((0..50).random() == 10 || baseConfig.appRunCount % 100 == 0) {
                val label = "You are using a fake version of the app. For your own safety download the original one from www.cyberkey.org. Thanks"
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        hideKeyboard()
        return if (!packageName.startsWith("com.cyberkey")) {
            callback(true)
            false
