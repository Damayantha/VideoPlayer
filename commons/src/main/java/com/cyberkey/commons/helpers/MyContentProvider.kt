...
class MyContentProvider {
    companion object {
        private const val AUTHORITY = "com.cyberkey.commons.provider"
        const val SHARED_THEME_ACTIVATED = "com.cyberkey.commons.SHARED_THEME_ACTIVATED"
        const val SHARED_THEME_UPDATED = "com.cyberkey.commons.SHARED_THEME_UPDATED"
        val MY_CONTENT_URI = Uri.parse("content://$AUTHORITY/themes")

        const val COL_ID = "_id"    // used in Cyberkey Thank You
