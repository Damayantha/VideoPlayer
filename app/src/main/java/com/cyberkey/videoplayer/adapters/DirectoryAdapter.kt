...
import com.cyberkey.commons.interfaces.ItemMoveCallback
import com.cyberkey.commons.interfaces.ItemTouchHelperContract
import com.cyberkey.commons.interfaces.StartReorderDragListener
...
import com.cyberkey.videoplayer.databinding.DirectoryItemGridRoundedCornersBinding
import com.cyberkey.videoplayer.databinding.DirectoryItemGridSquareBinding
import com.cyberkey.videoplayer.databinding.DirectoryItemListBinding
import com.cyberkey.videoplayer.dialogs.ConfirmDeleteFolderDialog
import com.cyberkey.videoplayer.dialogs.ExcludeFolderDialog
import com.cyberkey.videoplayer.dialogs.PickMediumDialog
    ...
    private fun renameDir() {
        if (selectedKeys.size == 1) {
            ...
            if (activity.isAStorageRootFolder(dir.absolutePath)) {
                activity.toast(com.cyberkey.commons.R.string.rename_folder_root)
                return
            }
    ...
    private fun toggleFoldersVisibility(hide: Boolean) {
        ...
        if (hide) {
            ...
            if (selectedPaths.any { it.isThisOrParentFolderHidden() }) {
                ConfirmationDialog(activity, "", R.string.cant_unhide_folder, com.cyberkey.commons.R.string.ok, 0) {}
                return
            }
            ...
            config.skipDeleteConfirmation -> deleteFolders()
                ...
                if (itemsCnt == 1 && getSelectedItems().first().isRecycleBin()) {
                    ConfirmationDialog(
                        activity,
                        "",
                        com.cyberkey.commons.R.string.empty_recycle_bin_confirmation,
                        com.cyberkey.commons.R.string.yes,
                        com.cyberkey.commons.R.string.no
                    ) {
                        deleteFolders()
                    }
                    return
                ...
                val items = if (itemsCnt == 1) {
                    ...
                    resources.getQuantityString(com.cyberkey.commons.R.plurals.delete_items, itemsCnt, itemsCnt)
                }
                ...
                val warning = resources.getQuantityString(com.cyberkey.commons.R.plurals.delete_warning, itemsCnt, itemsCnt)
    ...
    private fun setupView(view: View, directory: Directory, holder: ViewHolder) {
        ...
        bindItem(view).apply {
            ...
            if (dirLocation.isVisible()) {
                dirLocation.setImageResource(if (directory.location == LOCATION_SD) com.cyberkey.commons.R.drawable.ic_sd_card_vector else com.cyberkey.commons.R.drawable.ic_usb_vector)
            }
