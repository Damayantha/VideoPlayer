...
class MediaFetcher(val context: Context) {
    ...
    private fun getFormattedKey(key: String, grouping: Int, today: String, yesterday: String, count: Int): String {
        ...
        if (result.isEmpty()) {
            result = context.getString(com.cyberkey.commons.R.string.unknown)
        }
    ...
    private fun getFinalDate(date: String, today: String, yesterday: String): String {
        return when (date) {
            today -> context.getString(com.cyberkey.commons.R.string.today)
            yesterday -> context.getString(com.cyberkey.commons.R.string.yesterday)
            else -> date
        }
    }
