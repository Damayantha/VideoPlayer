...
const val HOME_UI = "hide_home_ui"
const val HIDE_CREATE_NEW_FOLDER = "hide_create_new_folder"
const val REMOVE_SPLASH_SCREEN = "remove_splash_screen"
...
fun getDefaultFileFilter() = TYPE_VIDEOS
