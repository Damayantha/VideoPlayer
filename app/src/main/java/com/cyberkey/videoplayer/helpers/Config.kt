package com.cyberkey.videoplayer.helpers
...
class Config(context: Context) : BaseConfig(context) {
    ...
    var hideHmeUI: Boolean
        get() = prefs.getBoolean(HOME_UI, false)
        set(hideHomeUI) = prefs.edit().putBoolean(HOME_UI, hideHomeUI).apply()
    var hideCreateNewFolder: Boolean
        get() = prefs.getBoolean(HIDE_CREATE_NEW_FOLDER, false)
        set(hideCreateNewFolder) = prefs.edit().putBoolean(HIDE_CREATE_NEW_FOLDER, hideCreateNewFolder).apply()

    var removeSplashScreen: Boolean
        get() = prefs.getBoolean(HIDE_CREATE_NEW_FOLDER, false)
        set(removeSplashScreen) = prefs.edit().putBoolean(HIDE_CREATE_NEW_FOLDER, removeSplashScreen).apply()
