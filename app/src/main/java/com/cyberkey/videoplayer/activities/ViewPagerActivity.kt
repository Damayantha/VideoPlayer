...
import com.cyberkey.commons.dialogs.PropertiesDialog
import com.cyberkey.commons.dialogs.RenameItemDialog
...
import com.cyberkey.videoplayer.adapters.MyPagerAdapter
import com.cyberkey.videoplayer.asynctasks.GetMediaAsynctask
import com.cyberkey.videoplayer.databinding.ActivityMediumBinding
import com.cyberkey.videoplayer.dialogs.DeleteWithRememberDialog
import com.cyberkey.videoplayer.dialogs.SlideshowDialog
...
class ViewPagerActivity : SimpleActivity(), ViewPager.OnPageChangeListener, ViewPagerFragment.FragmentListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        handlePermission(getPermissionToRequest()) {
            if (it) {
                ...
                toast(com.cyberkey.commons.R.string.no_storage_permissions)
                finish()
            }
        }
    ...
    private fun setupOptionsMenu() {
        ...
        binding.mediumViewerToolbar.apply {
            ...
            overflowIcon = resources.getColoredDrawableWithColor(com.cyberkey.commons.R.drawable.ic_three_dots_vector, Color.WHITE)
            navigationIcon = resources.getColoredDrawableWithColor(com.cyberkey.commons.R.drawable.ic_arrow_left_vector, Color.WHITE)
        }
    ...
    private fun copyMoveTo(isCopyOperation: Boolean) {
        ...
        if (!isCopyOperation && currPath.startsWith(recycleBinPath)) {
            toast(com.cyberkey.commons.R.string.moving_recycle_bin_items_disabled, Toast.LENGTH_LONG)
            return
        }
    ...
    private fun initBottomActionButtons() {
        ...
        binding.bottomActions.bottomShare.setOnLongClickListener { toast(com.cyberkey.commons.R.string.share); true }
        ...
        binding.bottomActions.bottomDelete.setOnLongClickListener { toast(com.cyberkey.commons.R.string.delete); true }
        ...
        binding.bottomActions.bottomProperties.setOnLongClickListener { toast(com.cyberkey.commons.R.string.properties); true }
        ...
        binding.bottomActions.bottomToggleFileVisibility.setOnLongClickListener {
            toast(if (currentMedium?.isHidden() == true) com.cyberkey.commons.R.string.unhide else com.cyberkey.commons.R.string.hide); true
        }
        ...
        binding.bottomActions.bottomRename.setOnLongClickListener { toast(com.cyberkey.commons.R.string.rename); true }
        ...
        binding.bottomActions.bottomCopy.setOnLongClickListener { toast(com.cyberkey.commons.R.string.copy); true }
        ...
        binding.bottomActions.bottomMove.setOnLongClickListener { toast(com.cyberkey.commons.R.string.move); true }
    ...
    private fun updateBottomActionIcons(medium: Medium?) {
        ...
        val favoriteIcon =
            if (medium.isFavorite) com.cyberkey.commons.R.drawable.ic_star_vector else com.cyberkey.commons.R.drawable.ic_star_outline_vector
        binding.bottomActions.bottomFavorite.setImageResource(favoriteIcon)

        val hideIcon =
            if (medium.isHidden()) com.cyberkey.commons.R.drawable.ic_unhide_vector else com.cyberkey.commons.R.drawable.ic_hide_vector
    ...
    private fun askConfirmDelete() {
        ...
        val baseString = if (config.useRecycleBin && !config.tempSkipRecycleBin && !isInRecycleBin) {
            com.cyberkey.commons.R.string.move_to_recycle_bin_confirmation
        } else {
            com.cyberkey.commons.R.string.deletion_confirmation
        }
    ...
    private fun renameFile() {
        ...
        if (isRPlus() && isSDOrOtgRootFolder && !isExternalStorageManager()) {
            toast(com.cyberkey.commons.R.string.rename_in_sd_card_system_restriction, Toast.LENGTH_LONG)
            return
        }
            ...
            Intent().apply {
                ...
                try {
                    ...
                    if (!tryGenericMimeType(this, mimeType, newUri)) {
                        toast(com.cyberkey.commons.R.string.no_app_found)
                    }
                } catch (e: Exception) {
                    showErrorToast(e)
                }
