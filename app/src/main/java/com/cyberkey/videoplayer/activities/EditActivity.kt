...
import com.cyberkey.commons.dialogs.ColorPickerDialog
import com.cyberkey.commons.extensions.*
import com.cyberkey.commons.helpers.NavigationIcon
import com.cyberkey.commons.helpers.REAL_FILE_PATH
import com.cyberkey.commons.helpers.ensureBackgroundThread
import com.cyberkey.commons.helpers.isNougatPlus
...
import com.cyberkey.videoplayer.adapters.FiltersAdapter
import com.cyberkey.videoplayer.databinding.ActivityEditBinding
import com.cyberkey.videoplayer.dialogs.OtherAspectRatioDialog
import com.cyberkey.videoplayer.dialogs.ResizeDialog
import com.cyberkey.videoplayer.dialogs.SaveAsDialog
import com.cyberkey.videoplayer.extensions.config
import com.cyberkey.videoplayer.extensions.copyNonDimensionAttributesTo
import com.cyberkey.videoplayer.extensions.fixDateTaken
import com.cyberkey.videoplayer.extensions.openEditor
import com.cyberkey.videoplayer.helpers.*
import com.cyberkey.videoplayer.models.FilterItem
...
class EditActivity : SimpleActivity(), CropImageView.OnCropImageCompleteListener {
        ...
        Glide.with(this)
            ...
            .listener(object : RequestListener<Bitmap> {
                ...
                override fun onResourceReady(
                    ...
                    if (filterInitialBitmap != null && currentFilter != null && currentFilter.filter.name != getString(com.cyberkey.commons.R.string.none)) {
    ...
    private fun saveImage() {
        ...
        if (binding.cropImageView.isVisible()) {
            ...
            val filePathGetter = getNewFilePath()
            SaveAsDialog(this, filePathGetter.first, filePathGetter.second) {
                toast(com.cyberkey.commons.R.string.saving)
        ...
        if (currPrimaryAction == PRIMARY_ACTION_FILTER && binding.bottomEditorFilterActions.bottomActionsFilterList.adapter == null) {
            ensureBackgroundThread {
                ...
                runOnUiThread {
                    ...
                    val noFilter = Filter(getString(com.cyberkey.commons.R.string.none))
    ...
    private fun scanFinalPath(path: String) {
        ...
        rescanPaths(paths) {
            ...
            setResult(Activity.RESULT_OK, intent)
            toast(com.cyberkey.commons.R.string.file_saved)
            finish()
        }
    }
