...
import com.cyberkey.videoplayer.databinding.ActivityWidgetConfigBinding
import com.cyberkey.videoplayer.dialogs.PickDirectoryDialog
import com.cyberkey.videoplayer.extensions.*
import com.cyberkey.videoplayer.helpers.MyWidgetProvider
import com.cyberkey.videoplayer.helpers.ROUNDED_CORNERS_NONE
import com.cyberkey.videoplayer.models.Directory
import com.cyberkey.videoplayer.models.Widget
...
class WidgetConfigureActivity : SimpleActivity() {
    ...
    private fun initVariables() {
        ...
        if (mTextColor == resources.getColor(com.cyberkey.commons.R.color.default_widget_text_color) && config.isUsingSystemTheme) {
            mTextColor = resources.getColor(com.cyberkey.commons.R.color.you_primary_color, theme)
        }
