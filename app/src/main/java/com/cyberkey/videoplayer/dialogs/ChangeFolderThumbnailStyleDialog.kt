...
import com.cyberkey.videoplayer.adapters.toItemBinding
import com.cyberkey.videoplayer.databinding.DialogChangeFolderThumbnailStyleBinding
    ...
    private fun updateSample() {
        ...
        binding.apply {
            ...
            if (useRoundedCornersLayout) {
                val cornerRadius = root.resources.getDimension(com.cyberkey.commons.R.dimen.rounded_corner_radius_big).toInt()
