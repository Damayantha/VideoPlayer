...
import com.cyberkey.videoplayer.databinding.DialogChangeSortingBinding
...
class ChangeSortingDialog(
    ...
    init {
        ...
        activity.getAlertDialogBuilder()
            ...
            .apply {
                activity.setupDialogStuff(binding.root, this, com.cyberkey.commons.R.string.sort_by)
            }
