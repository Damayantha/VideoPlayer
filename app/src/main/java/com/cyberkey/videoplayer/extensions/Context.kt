...
import com.cyberkey.commons.views.MySquareImageView
...
import com.cyberkey.videoplayer.svg.SvgSoftwareLayerSetter
import java.io.File
...
fun Context.getFolderNameFromPath(path: String): String {
    return when (path) {
        internalStoragePath -> getString(com.cyberkey.commons.R.string.internal)
        sdCardPath -> getString(com.cyberkey.commons.R.string.sd_card)
        otgPath -> getString(com.cyberkey.commons.R.string.usb)
        FAVORITES -> getString(com.cyberkey.commons.R.string.favorites)
        RECYCLE_BIN -> getString(com.cyberkey.commons.R.string.recycle_bin)
...
fun Context.loadImageBase(
    ...
    if (roundCorners != ROUNDED_CORNERS_NONE) {
        val cornerSize =
            if (roundCorners == ROUNDED_CORNERS_SMALL) com.cyberkey.commons.R.dimen.rounded_corner_radius_small else com.cyberkey.commons.R.dimen.rounded_corner_radius_big
